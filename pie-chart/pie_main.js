let pie_area = (function(){
    d3.json('pie-chart/archive_structure.json', init) // read data set and pass it to callback
    ...
    let config_template  = {
        ...
        min_radius : 50,           // pie chart's minimum outer radius
            ...
            div_id : 'pie-chart',  // class of the div container holding the chart
    ...
    function init(json) {
        ...
        config_array[0].data         = json
        config_array[0].div_id       = 'drill-down-pie-chart-1'
        ...
        config_array[1].data         = json
        config_array[1].div_id       = 'drill-down-pie-chart-2'
        config_array[1].headline     = true
        config_array[1].labels       = true
        config_array[1].color        = 'pink'
        config_array[1].label_size   = 14

        config_array[2].data         = json
        config_array[2].div_id       = 'drill-down-pie-chart-3'
        config_array[2].legend       = true
        config_array[2].color        = 'cat10'

        config_array[3].data         = json
        config_array[3].div_id       = 'drill-down-pie-chart-4'
